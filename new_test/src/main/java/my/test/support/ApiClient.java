...
import my.test.support.auth.Authentication;
import my.test.support.auth.HttpBasicAuth;
import my.test.support.auth.ApiKeyAuth;
import my.test.support.auth.OAuth;
